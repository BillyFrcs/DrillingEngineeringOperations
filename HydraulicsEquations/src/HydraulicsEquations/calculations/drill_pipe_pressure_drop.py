...
class DrillPipePressureDrop(object):
    ...
    def calculate_velocity(self):
        """
        Velocity: 
        Vp (ft/min) = 24.48 x Q (gpm) / D2 (in.) = 24.48 x 335 / 3.826 2 = ... ft/min ...m/min
        """
    ...
    def calculate_effective_viscosity(self):
        ...
        """
        self.effective_viscosity = (100 * 3.21 * ((math.pow((1.6 * 560.23) / 3.826, 0.64 - 1))) * math.pow((3 * 0.64 + 1) / (4 * 0.64), 0.64)) 
    ...
    def calculate_reynolds_number(self):
        ...
        """
        self.reynolds_number = (15.467 * 560.22 * self.inside_diameter * self.mud_density) / 48.97
    ...
    def display_results(self):
        ...
        print("\nDRILL STRING INTERVAL #1 (DRILL PIPE):")
