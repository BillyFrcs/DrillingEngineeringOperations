...
namespace DrillingSystem.Services
{
    internal class HydrostaticPressureService : IHydrostaticPressure
    {
        ...
        private HydrostaticPressure _hydrostaticPressure;

        public HydrostaticPressureService()
        {
            if (_hydrostaticPressure == null)
            {
                _hydrostaticPressure = new HydrostaticPressure
                {
                    MudWeightPpg = 12.2,
        ...
        public void ImperialHydrostaticPressureResult()
        {
            ...
            double imperialHP = ImperialHydrostaticPressureCalculation(hpEngine, _hydrostaticPressure.MudWeightPpg,  _hydrostaticPressure.TrueVerticalDepthFeet);
        ...
        public void MetricHydrostaticPressureResult()
        {
            ...
            double metricHP = MetricHydrostaticPressureCalculation(hpEngine, _hydrostaticPressure.MudWeightSg, _hydrostaticPressure.TrueVerticalDepthMeter);
