...
namespace DrillingSystem.DrillingConsole.Services
{
    internal class EquivalentCirculatingDensityService : IEquivalentCirculatingDensity
    {
        ...
        [DllImport("DrillingEngine.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImperialEquivalentCirculatingDensityCalculation(IntPtr drillingEngine, double mudWeight_ppg, double annularPressureLoss_psi, double trueVerticalDepth_feet);

        [DllImport("DrillingEngine.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern double MetricEquivalentCirculatingDensityCalculation(IntPtr drillingEngine, double mudWeight_ppg, double annularPressureLoss_psi, double trueVerticalDepth_feet);
        ...
        public EquivalentCirculatingDensityService()
        {
            if (_equivalentCirculatingDensityModel == null)
            {
                ...
                {
                    MudWeightPpg = 0,
                    AnnularPressureLossPsi = 0,
                    TrueVerticalDepthFeet = 0,
                    MudWeightKgM3 = 0,
                    AnnularPressureLosskPa = 0,
        ...
        public void ImperialEquivalentCirculatingDensityResult()
        {
            ...
            double annularPressureLoss = Validations.ReadNumericLine("Enter Annular Pressure Loss (psi): ");
            ...
            _equivalentCirculatingDensityModel.AnnularPressureLossPsi = annularPressureLoss;
            _equivalentCirculatingDensityModel.TrueVerticalDepthFeet = trueVerticalDepth;

            double imperialEcd = ImperialEquivalentCirculatingDensityCalculation(ecdEngine, _equivalentCirculatingDensityModel.MudWeightPpg, _equivalentCirculatingDensityModel.AnnularPressureLossPsi, _equivalentCirculatingDensityModel.TrueVerticalDepthFeet);
        ...
        public void MetricEquivalentCirculatingDensityResult()
        {
            ...
            double annularPressureLoss = Validations.ReadNumericLine("Enter Annular Pressure Loss (kPa): ");
            ...
            _equivalentCirculatingDensityModel.AnnularPressureLosskPa = annularPressureLoss;
            _equivalentCirculatingDensityModel.TrueVerticalDepthMeter = trueVerticalDepth;

            double metricEcd = MetricEquivalentCirculatingDensityCalculation(ecdEngine, _equivalentCirculatingDensityModel.MudWeightKgM3, _equivalentCirculatingDensityModel.AnnularPressureLosskPa, _equivalentCirculatingDensityModel.TrueVerticalDepthMeter);
