...
{
	DrillingSystem::DrillingEngine::Logging::Debug(m_DrillingEngine->ImperialKillWeightMud(9.5, 500, 9000));
	DrillingSystem::DrillingEngine::Logging::Debug(m_DrillingEngine->MetricKillWeightMud(1140, 3450, 2700));
}
